...
var _user$project$Types$encodeVec3 = function (vec) {
	var _p0 = _opensolid$geometry$OpenSolid_Vector3d$components(vec);
	var x = _p0._0;
	var y = _p0._1;
	var z = _p0._2;
	return _elm_lang$core$Json_Encode$object(
...
var _user$project$Types$graphToJson = function (_p1) {
	return A2(
		_elm_lang$core$Json_Encode$encode,
		0,
		_user$project$Types$encodeGraph(_p1));
};
		...
		return function (_p4) {
			return _opensolid$geometry$OpenSolid_Geometry_Types$Vector3d(
				A2(
					...
					_opensolid$geometry$OpenSolid_Vector3d$components(_p4)));
		};
	});
...
var _user$project$Types$shapeFromString = function (str) {
	...
	switch (_p8) {
		case 'Box':
			return _elm_lang$core$Result$Ok(_user$project$Types$Box);
		case 'Sphere':
		...
		A2(
			...
			function (_p9) {
				return A2(
					...
					_user$project$Types$Box,
					_user$project$Types$shapeFromString(_p9));
			},
			_elm_lang$core$Json_Decode$string)),
	A2(
		_elm_lang$core$Json_Decode$field,
		...
		A2(
			...
			function (_p10) {
				return A2(
					...
					_eskimoblood$elm_color_extra$Color_Convert$hexToColor(_p10));
			},
			_elm_lang$core$Json_Decode$string)),
...
var _user$project$Types$decodeGraph = function (_p11) {
	return A2(
		_elm_lang$core$Result$map,
		function (_p12) {
			var _p13 = _p12;
			return A2(_elm_community$graph$Graph$fromNodesAndEdges, _p13.nodes, _p13.edges);
		},
		A2(_elm_lang$core$Json_Decode$decodeString, _user$project$Types$graphDecoder, _p11));
};
var _user$project$Types$GeneralSettings = {ctor: 'GeneralSettings'};
...
var _user$project$Types$ShowOrHideUi = function (a) {
	return {ctor: 'ShowOrHideUi', _0: a};
};
var _user$project$Types$ToggleVrMode = function (a) {
	return {ctor: 'ToggleVrMode', _0: a};
};
var _user$project$Types$Load = function (a) {
	return {ctor: 'Load', _0: a};
};
var _user$project$Types$Save = {ctor: 'Save'};
var _user$project$Types$NewProject = {ctor: 'NewProject'};
...
var _user$project$Types$ChangeShape = F2(
	function (a, b) {
...
var _user$project$Types$ChangeRootId = function (a) {
	return {ctor: 'ChangeRootId', _0: a};
};
var _user$project$Types$ChangeBackgroundColor = function (a) {
	return {ctor: 'ChangeBackgroundColor', _0: a};
};
...
var _user$project$MyStyles$shapePicker = {
	ctor: '::',
	_0: A2(_user$project$MyStyles_ops['=>'], 'padding', '20px'),
	_1: {
		ctor: '::',
		_0: A2(_user$project$MyStyles_ops['=>'], 'background', 'yellow'),
		_1: {ctor: '[]'}
	}
};
...
var _user$project$MyStyles$Button = {ctor: 'Button'};
...
var _user$project$MyStyles$Expanded = {ctor: 'Expanded'};
					...
					_0: A2(
						...
						_user$project$MyStyles$SelectorItem,
						{
							...
							_0: _mdgriffith$style_elements$Style_Color$background(
								A4(_elm_lang$core$Color$rgba, 0, 0, 0, 0)),
							_1: {
								ctor: '::',
									...
									_1: {
										...
										_1: {
											...
											_0: A2(
												...
												{
													ctor: '::',
													_0: _mdgriffith$style_elements$Style_Color$border(_elm_lang$core$Color$darkGrey),
													_1: {
														ctor: '::',
														_0: _mdgriffith$style_elements$Style$hover(
															{
												...
												_0: A2(
													...
													_user$project$MyStyles$Dropdown,
													{
														...
														_1: {
															...
															_0: A2(
																_mdgriffith$style_elements$Style$variation,
																_user$project$MyStyles$Expanded,
																{
																	ctor: '::',
																	_0: _mdgriffith$style_elements$Style_Color$background(
																		_elm_lang$core$Color$greyscale(0.7)),
	...
	_user$project$MyStyles$Button,
	{
		...
		_1: {
			...
			_1: {
				...
				_1: {
					ctor: '::',
					_0: _mdgriffith$style_elements$Element_Attributes$id('saveButton'),
					_1: {
						ctor: '::',
	...
	return A3(
		...
		},
		{
			...
			_0: A3(
				...
				_mdgriffith$style_elements$Element$text('Uh Oh! No WebGL')),
			_1: {
				ctor: '::',
				_0: A3(
					...
					{
						ctor: '::',
						_0: _mdgriffith$style_elements$Element$text('It looks like you don\'t have'),
						_1: {
							ctor: '::',
							_0: A3(
								_mdgriffith$style_elements$Element$el,
								_user$project$MyStyles$None,
								{
									...
									_0: _mdgriffith$style_elements$Element_Attributes$inlineStyle(
										{
											ctor: '::',
											_0: A2(_user$project$Types_ops['=>'], 'color', 'blue'),
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								},
			...
			_1: {
				...
				_0: A2(
					...
					A2(
						...
						_eskimoblood$elm_color_extra$Color_Convert$colorToHex(model.backgroundColor))),
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$style(
						{
							ctor: '::',
							_0: A2(_user$project$Types_ops['=>'], 'cursor', 'all-scroll'),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						...
						_1: {
							...
							_1: {
								ctor: '::',
								_0: A2(_elm_lang$html$Html_Attributes$attribute, 'scene', 'true'),
								_1: {ctor: '[]'}
							}
						}
					}
...
var _user$project$View$unless = F3(
	function (exception, backup, $default) {
		return exception ? backup : $default;
	});
var _user$project$View$viewSceneContainer = function (model) {
	...
	var sceneContents = A3(
		...
		{
			ctor: '::',
			_0: _user$project$View$viewNoWebGLNotification,
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
...
var _user$project$View$Vertical = {ctor: 'Vertical'};
var _user$project$View$Horizontal = {ctor: 'Horizontal'};
var _user$project$View$dropdown = F2(
		...
		return A2(
					...
					_user$project$MyStyles$Dropdown,
					{
						...
						_1: {
							...
							_0: _user$project$View$hideUnless(
								_elm_lang$core$Native_Utils.eq(model.focusedUi, config.uiElement)),
							_1: {ctor: '[]'}
						}
					},
					A3(
						_elm_lang$core$Native_Utils.eq(config.orientation, _user$project$View$Horizontal) ? _mdgriffith$style_elements$Element$row : _mdgriffith$style_elements$Element$column,
						_user$project$MyStyles$None,
						{
							ctor: '::',
							_0: _mdgriffith$style_elements$Element_Attributes$width(
			...
			A3(
				...
				_user$project$MyStyles$Dropdown,
				{
					...
					_0: _mdgriffith$style_elements$Element_Events$onMouseEnter(
						_user$project$Types$ShowOrHideUi(
							_user$project$Types$Show(config.uiElement))),
					_1: {
						ctor: '::',
...
var _user$project$View$viewNodeDetail = F2(
	function (model, node) {
								...
								_1: {
									...
									_1: {
										...
										_0: _elm_lang$html$Html_Events$onInput(
											A2(createMsg, _elm_lang$core$String$toFloat, _user$project$Types$ChangeOpacity)),
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$style(
												A2(
		...
		var shapePicker = A2(
			...
			model,
			{
				viewHead: A3(
					...
					_mdgriffith$style_elements$Element$text(
						_elm_lang$core$Basics$toString(node.label.shape))),
				uiElement: _user$project$Types$EditNodeShapeMenu,
				options: {
					ctor: '::',
					_0: _user$project$Types$Box,
					_1: {
						ctor: '::',
						_0: _user$project$Types$Sphere,
						_1: {
							ctor: '::',
				...
				onClick: _user$project$Types$ChangeShape(node.id),
				...
				return A3(
					...
					{ctor: '[]'},
					{
						...
						_0: A3(
							...
							{
								ctor: '::',
								_0: _mdgriffith$style_elements$Element$text(str),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
		...
		return A3(
			...
			{
				ctor: '::',
				_0: A2(inputWithLabel, 'Color:', colorPicker),
				_1: {
					ctor: '::',
...
var _user$project$View$viewEdgeDetail = F2(
	function (model, edge) {
		...
		var headerWithDropdown = A3(
			_mdgriffith$style_elements$Element$column,
			_user$project$MyStyles$None,
			{ctor: '[]'},
			{
				ctor: '::',
				_0: _mdgriffith$style_elements$Element$text('Relationship:'),
				_1: {
					ctor: '::',
					_0: A2(
						_user$project$View$dropdown,
...
var _user$project$View$viewGeneralSettingsDetail = function (model) {
	var rootNode = A2(
		_elm_lang$core$Maybe$map,
		function (_) {
			return _.node;
	...
	var rootMenu = A2(
		...
		model,
		{
			...
			uiElement: _user$project$Types$EditRootMenu,
			options: _elm_community$graph$Graph$nodes(model.graph),
			viewOption: function (n) {
				return A3(
					_mdgriffith$style_elements$Element$column,
					_user$project$MyStyles$None,
					{
					...
					{
						ctor: '::',
						_0: _mdgriffith$style_elements$Element$text('Change to'),
						_1: {
							ctor: '::',
							_0: A4(
								_user$project$View$viewNodeBadge,
		...
		A2(
			_elm_lang$html$Html$input,
			{
				...
				_1: {
					...
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onInput(_user$project$Types$ChangeBackgroundColor),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$style(_user$project$MyStyles$colorPicker),
							_1: {ctor: '[]'}
	...
	return A3(
		...
		},
		{
			...
			_1: {
				ctor: '::',
				_0: A2(inputWithLabel, 'First Thing:', rootMenu),
				_1: {ctor: '[]'}
			}
		});
};
		...
		switch (_p23._0.ctor) {
			...
			default:
				return sidebar(
					{
						ctor: '::',
						_0: _user$project$View$viewGeneralSettingsDetail(model),
						_1: {ctor: '[]'}
					});
		}
	}
...
var _user$project$View$viewSelectionSidebar = function (model) {
	var skySelector = function () {
		var skyEdge = A3(_elm_community$graph$Graph$Edge, -1, model.rootId, _user$project$Types$emptyTransformation);
		var skynode = A2(
			_elm_community$graph$Graph$Node,
			-1,
			{color: model.backgroundColor, opacity: 1, shape: _user$project$Types$Box});
		return A3(
			_mdgriffith$style_elements$Element$el,
			_user$project$MyStyles$SelectorItem,
			{
				...
				_1: {
					ctor: '::',
					_0: _mdgriffith$style_elements$Element_Events$onClick(
						_user$project$Types$Edit(_user$project$Types$GeneralSettings)),
					_1: {
						ctor: '::',
						_0: A2(
							_mdgriffith$style_elements$Element_Attributes$vary,
							...
							_elm_lang$core$Native_Utils.eq(
								model.editing,
								_elm_lang$core$Maybe$Just(_user$project$Types$GeneralSettings))),
						_1: {ctor: '[]'}
					}
				}
			},
				...
				A3(
					...
					_user$project$MyStyles$None,
					{
						...
						_1: {
							...
							_1: {
								ctor: '::',
								_0: A2(_mdgriffith$style_elements$Element_Attributes$vary, _user$project$MyStyles$NewButton, true),
								_1: {ctor: '[]'}
							}
						}
					},
	...
	var newNodeMenu = A2(
		...
		model,
		{
			viewHead: A2(newButton, 40, _user$project$Types$NewNodeMenu),
			uiElement: _user$project$Types$NewNodeMenu,
			options: _elm_community$graph$Graph$nodes(model.graph),
			viewOption: function (n) {
				return A3(
					_mdgriffith$style_elements$Element$column,
			...
			onClick: function (n) {
				return _user$project$Types$NewNode(n.id);
			},
			orientation: _user$project$View$Horizontal
		});
	var newEdgeMenu = A2(
	...
	var viewBadgeSelectors = F4(
		function (model, getoptions, viewoptions, stuffAfterBadges) {
			return A3(
				_mdgriffith$style_elements$Element$column,
				_user$project$MyStyles$None,
				{
						...
						},
						{
							...
							_0: A3(
								...
								A2(
									...
									A2(
										_elm_lang$core$List$map,
										_user$project$View$viewNodeSelector(model),
									...
									_elm_lang$core$List$concat(
										{
											...
											_1: {
												...
												_0: _elm_lang$core$List$reverse(
													A2(
														_elm_lang$core$List$map,
														_user$project$View$viewEdgeSelector(model),
			...
			_user$project$MyStyles$Main,
			{
				...
				_0: _mdgriffith$style_elements$Element_Attributes$height(
					A3(
						...
						_mdgriffith$style_elements$Element_Attributes$fill)),
				_1: {
					ctor: '::',
					_0: _mdgriffith$style_elements$Element_Events$onClick(
						(!_elm_lang$core$Native_Utils.eq(model.focusedUi, _user$project$Types$NoElem)) ? _user$project$Types$ShowOrHideUi(_user$project$Types$Hide) : _user$project$Types$NoOp),
					_1: {ctor: '[]'}
				}
			},
			{
...
var _user$project$Main$updateNode = F3(
	function (model, id, updaterFunc) {
		return _elm_lang$core$Native_Utils.update(
			model,
			{
				graph: A3(_user$project$Graph_Extra$updateNode, id, updaterFunc, model.graph)
			});
	});
var _user$project$Main$basicEntity = {
		...
		while (true) {
			...
			switch (_p2.ctor) {
				...
				case 'NewNode':
					var nextId = A2(
						...
						A2(
							...
							_elm_community$graph$Graph$nodeIdRange(model.graph)));
					var node = {id: nextId, label: _user$project$Main$basicEntity};
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{
								backgroundColor: A2(
									...
									_eskimoblood$elm_color_extra$Color_Convert$hexToColor(_p2._0))
							}),
						{ctor: '[]'});
				case 'ChangeRootId':
					return A2(
				...
				case 'ChangeColor':
					...
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						A3(_user$project$Main$updateNode, model, _p2._0, setNewColor),
						{ctor: '[]'});
				case 'ChangeOpacity':
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						A3(
							_user$project$Main$updateNode,
							model,
							_p2._0,
							_user$project$Types$nodeLensOpacity.set(_p2._1)),
						{ctor: '[]'});
				case 'ChangeShape':
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						A3(
							...
							model,
							_p2._0,
							_user$project$Types$nodeLensShape.set(_p2._1)),
						{ctor: '[]'});
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{
								graph: A2(
									...
									{
										ctor: '::',
										_0: A2(_elm_community$graph$Graph$Node, 0, _user$project$Main$basicEntity),
										_1: {ctor: '[]'}
									},
									{ctor: '[]'}),
								editing: _elm_lang$core$Maybe$Just(
									_user$project$Types$Node(0))
							}),
						{ctor: '[]'});
				case 'Save':
					var json = A2(
					...
					var answer = function () {
						...
						switch (_p10.ctor) {
							case 'Show':
								return _p10._0;
							case 'Hide':
								return _user$project$Types$NoElem;
							default:
								var _p11 = _p10._0;
								return _elm_lang$core$Native_Utils.eq(model.focusedUi, _p11) ? _user$project$Types$NoElem : _p11;
						}
					}();
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
				...
				case 'WindowResize':
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{
								device: _mdgriffith$style_elements$Element$classifyDevice(_p2._0)
							}),
						{ctor: '[]'});
				default:
					return A2(
...
var _user$project$Main$toggleVrMode = _elm_lang$core$Native_Platform.incomingPort('toggleVrMode', _elm_lang$core$Json_Decode$bool);
	...
	return _elm_lang$core$Platform_Sub$batch(
		{
			...
			_1: {
				ctor: '::',
				_0: _user$project$Main$toggleVrMode(_user$project$Types$ToggleVrMode),
				_1: {ctor: '[]'}
			}
		});
};
var _user$project$Main$main = _elm_lang$html$Html$programWithFlags(
	...
	A2(
		...
		A2(_elm_lang$core$Json_Decode$field, 'webGLSupport', _elm_lang$core$Json_Decode$bool)));
var _user$project$Main$Flags = function (a) {
	return {webGLSupport: a};
};
